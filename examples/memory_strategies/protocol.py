...
class MemoryStrategy(Protocol):
    ...
    def recall(self, *, store, user_id: str, messages: Sequence[BaseMessage]) -> list[dict]:
    ...
    def remember(
        self, *, store, user_id: str, last_user_msg: BaseMessage | None, messages: Sequence[BaseMessage]
    ) -> None:
